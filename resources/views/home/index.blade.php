       ...
       <span class="col-left catlist-style2">
          ...
          <article class="home-blog-entry clr">
           ...
           <div class="postlist-meta">
            ...
            <span class="delim"></span>
            <span class="postlist-meta-comments"><i class="fa fa-comments"></i>&nbsp;<a href="http://www.iydu.net/5151.html#comments">0</a></span>
       ...
       <span class="col-right catlist-style2">
         ...
         @foreach($v->article as $m=>$n)
          ...
          <article class="clr col-small">
           <a href="{{ url('details/'.$n->art_id) }}" title="{{ $n->art_title }}" class="fancyimg home-blog-entry-thumb">
            <div class="thumb-img">
             <img src="{{ $n->art_thumb }}" alt="{{ $n->art_title }}" />
             <span><i class="fa fa-pencil"></i></span>
            </div> </a>
           <h3><a href="http://www.iydu.net/5150.html" title="{{ $n->art_title }}">{{ $n->art_title }}</a></h3>
           <p> {{ $n->art_description }}<a rel="nofollow" class="more-link" style="text-decoration:none;" href="{{ url('details/'.$n->art_id) }}"></a> </p>
          </article>
